...
import { useAllTasks, useTaskMutations } from "@/lib/hooks";
import { useAppStore } from "@/lib/store";
import type { TaskWithRelations } from "@/lib/types";

export default function AllPage() {
  const { tasks, isLoading, isError, mutate } = useAllTasks();
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          >
            {incompleteTasks.length} task{incompleteTasks.length !== 1 ? "s" : ""} total
          </motion.p>
        </div>
        <motion.div
